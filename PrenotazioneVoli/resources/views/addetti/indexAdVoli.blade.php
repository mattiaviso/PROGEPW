            ...
            <div class="input-group">
                <div class="input-group-prepend">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="dropdown-item searchOptions" href="#"
                                data-column="2">{{trans('messages.nomeCompagnia')}}</a></li>
                        <li><a class="dropdown-item searchOptions" href="#"
                                data-column="3">{{trans('messages.email')}}</a></li>
                    </ul>
                </div>
...
<div class="container mt-4">
    <div class="col-md-12 table-responsive">
        <table id="voliTable" class="table table-hover table-striped table-bordered table-bordered-custom">
            <col width='10%'>
            <col width='10%'>
            <col width='20%'>
            <col width='30%'>
...
<script>
    $(document).ready(function () {
        ...
        $("#searchInput").on("keyup", function () {
            ...
            $("#voliTable tbody tr").each(function () {
                var found = false;
